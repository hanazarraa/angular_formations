...
@Component({
  selector: 'app-consulter-cours-responsable',
  templateUrl: './consulter-cours-responsable.component.html',
  styleUrls: ['./consulter-cours-responsable.component.scss']
})
export class ConsulterCoursResponsableComponent implements OnInit {
  documents:Array<Doc>=[];
  newDocument:any={};
