...
@Component({
  selector: 'app-courses-program-responsable',
  templateUrl: './courses-program-responsable.component.html',
  styleUrls: ['./courses-program-responsable.component.scss']
})
export class CoursesProgramResponsableComponent implements OnInit {
 ...
 programmeID:any;
  ...
  onAddItem() {
    ...
    this.router.navigate(["programmes/"+this.programmeID+"/cours/ajouter"]);
