...
@Component({
  selector: 'app-creer-cours-responsable',
  templateUrl: './creer-cours-responsable.component.html',
  styleUrls: ['./creer-cours-responsable.component.scss']
})
export class CreerCoursResponsableComponent implements OnInit {
